        ...
        <Row>
          ...
          <Col xl="9" lg="8">
            <Card>
              <Card.Header className="d-flex justify-content-between">
                <div className="header-title">
                  <h4 className="card-title">Informations sur le nouvel utilisateur</h4>
                </div>
              </Card.Header>
              <Card.Body>
                <div className="new-user-info">
                  <form>
                    <div className="row">
                      ...
                      <Form.Group className="col-md-6 form-group">
                        <Form.Label htmlFor="add2">Adresse (suite) :</Form.Label>
                        <Form.Control type="text"  id="add2"/>
                      </Form.Group>
                      <Form.Group className="col-md-12 form-group">
                        <Form.Label htmlFor="cname">Nom de l'entreprise :</Form.Label>
                      ...
                      <Form.Group className="col-md-6  form-group">
                        <Form.Label htmlFor="mobno">Numéro de téléphone mobile :</Form.Label>
                        <Form.Control type="text"  id="mobno"/>
                      </Form.Group>
                      <Form.Group className="col-md-6  form-group">
                        <Form.Label htmlFor="altconno">Contact alternatif :</Form.Label>
                    ...
                    <div className="row">
                      <Form.Group className="col-md-12 form-group">
                        <Form.Label htmlFor="uname">Nom d'utilisateur :</Form.Label>
                      ...
                      <Form.Group className="col-md-6 form-group">
                        <Form.Label htmlFor="rpass">Répéter le mot de passe :</Form.Label>
                        <Form.Control type="password"  id="rpass"/>
                      </Form.Group>
                    </div>
                    <div className="checkbox">
                      <label className="form-label"><input type="checkbox" className="me-2 form-check-input"  value="" id="flexCheckChecked"/>Activer l'authentification à deux facteurs</label>
                    </div>
                    <Button type="button" variant="btn btn-primary">Ajouter un nouvel utilisateur</Button>
                  </form>
                </div>
              </Card.Body>
            </Card>
